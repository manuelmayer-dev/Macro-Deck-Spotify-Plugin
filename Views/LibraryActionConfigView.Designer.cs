...
namespace Develeon64.SpotifyPlugin.Views {
	public partial class LibraryActionConfigView {
		/// <summary>
		...
		private void InitializeComponent () {
			...
			// 
			// LibraryActionConfigView
			// 
			this.Controls.Add(this.rbtToggle);
			this.Controls.Add(this.rbtOn);
			this.Controls.Add(this.rbtOff);
			this.Controls.Add(this.lblMode);
			this.Name = "LibraryActionConfigView";
			this.Load += new System.EventHandler(this.LibraryActionConfigView_Load);
