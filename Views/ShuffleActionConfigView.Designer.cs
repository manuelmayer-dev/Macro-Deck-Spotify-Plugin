...
namespace Develeon64.SpotifyPlugin.Views {
	public partial class ShuffleActionConfigView {
		/// <summary>
		...
		private void InitializeComponent () {
			...
			// 
			// ShuffleActionConfigView
			// 
			this.Controls.Add(this.rbtToggle);
			this.Controls.Add(this.rbtOn);
			this.Controls.Add(this.rbtOff);
			this.Controls.Add(this.lblMode);
			this.Name = "ShuffleActionConfigView";
			this.Load += new System.EventHandler(this.ShuffleActionConfigView_Load);
